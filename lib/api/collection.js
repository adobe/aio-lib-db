 ...
 * @throws {AbdbError}
 */
async function drop(abdb, collectionName, options = {}) {
  await postCollectionApi(abdb, collectionName, 'drop', undefined, options)
}
 ...
 * @throws {AbdbError}
 */
async function renameCollection(abdb, collectionName, newCollectionName, options = {}) {
  await postCollectionApi(abdb, collectionName, 'renameCollection', { name: newCollectionName }, options)
}
 ...
 * @throws {AbdbError}
 */
async function validate(abdb, collectionName, options = {}) {
  return await postCollectionApi(abdb, collectionName, 'validate', undefined, options)
}
 ...
 * @throws {AbdbError}
 */
async function stats(abdb, collectionName, options = {}) {
  return await postCollectionApi(abdb, collectionName, 'stats', undefined, options)
}
