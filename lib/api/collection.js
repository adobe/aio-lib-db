 ...
 * @throws {AbdbError}
 */
async function distinct(tenantId, axiosClient, collectionName, field, filter = {}, options = {}) {
  return await postCollectionApi(
    tenantId,
    axiosClient,
    collectionName,
    'distinct',
    { field: field, query: filter }, // TODO: Rename query to filter after CEXT-4687 PR is merged
    options
  )
}
 ...
 * @throws {AbdbError}
 */
async function countDocuments(tenantId, axiosClient, collectionName, filter = {}, options = {}) {
  return await postCollectionApi(
    tenantId,
    axiosClient,
    collectionName,
    'countDocuments',
    { query: filter }, // TODO: Rename query to filter after CEXT-4687 PR is merged
    options
  )
}
 ...
 * @throws {AbdbError}
 */
async function estimatedDocumentCount(tenantId, axiosClient, collectionName, options = {}) {
  return await postCollectionApi(
    tenantId,
    axiosClient,
    collectionName,
