...
class Db {
  ...
  constructor(runtimeNamespace = undefined, runtimeAuth = undefined) {
    ...
    console.log('Db instance initialized successfully.')
  }

  /**
   * Instantiates and returns a new Db object
   *
   * @static
   * @constructs
   ...
   * @returns {Promise<Db>} a new Db instance
   * @memberof Db
   */
  static async init(runtimeNamespace = undefined, runtimeAuth = undefined) {
    return new Db(runtimeNamespace, runtimeAuth)
  }
  ...
  /**
   * Initialize connection to DB Proxy Service
   *
  ...
  /**
   * General connectivity check with DB service
   *
