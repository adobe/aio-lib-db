...
class Cursor {
  ...
  /**
   * Get a readable stream version of the cursor
   *
   * @param {{(doc: Object): Object}=} transform
...
/**
 * Helper class for using the cursor as a stream
 */
  ...
  async _read(size) {
    if (!this.#readInProgress) {
      ...
      try {
        ...
        this.push(await this.#cursor.next())
