...
class AbdbCollection {
  ...
  async findOne(filter, options = {}) {
    return findOneApi(this.tenantId, this.axiosClient, this.name, filter, options)
  }
  ...
  async distinct(field, filter = {}, options = {}) {
    return distinctApi(this.tenantId, this.axiosClient, this.name, field, filter, options)
  }
  ...
  async countDocuments(filter = {}, options = {}) {
    return countDocumentsApi(this.tenantId, this.axiosClient, this.name, filter, options)
  }
  ...
  async estimatedDocumentCount(options = {}) {
    return estimatedDocumentCountApi(this.tenantId, this.axiosClient, this.name, options)
  }
}
