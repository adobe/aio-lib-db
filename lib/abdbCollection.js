...
class AbdbCollection {
   ...
   */
  async drop(options = {}) {
    return dropApi(this.abdb, this.name, options)
  }
  ...
  async renameCollection(newCollectionName, options = {}) {
    await renameCollectionApi(this.abdb, this.name, newCollectionName, options)
  ...
  async validate(options = {}) {
    return validateApi(this.abdb, this.name, options)
  }
   ...
   */
  async stats(options = {}) {
    return statsApi(this.abdb, this.name, options)
  }
}
