...
const { connectApi, provisionApi, statusApi, pingApi } = require('./api/abdb')
...
class Abdb {
  /**
   * @param {Object<{"tenant_id": string}>} credentials
   * @hideconstructor
   */
   ...
   * @static
   * @constructs
   * @param {Object<{"tenant_id": string}>} credentials initialization parameters
   ...
   */
  async ping() {
    return await pingApi(this.axiosClient)
  }
}
