...
class DbBase {
   ...
   * @param {boolean=} config.useCachedToken use cached IMS token when resolving from context
  ...
  static async init(config = {}) {
    ...
    const db = new DbBase(region, namespace, apikey)
    db.useCachedToken = config.useCachedToken === true
    return db
  }
